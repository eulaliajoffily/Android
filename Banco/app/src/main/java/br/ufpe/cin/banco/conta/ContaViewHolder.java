...
public class ContaViewHolder extends RecyclerView.ViewHolder {
    ...
    ContaViewModel viewModel = new ContaViewModel(new Application());
    ...
    void bindTo(Conta c) {
        ...
        String string_saldo = NumberFormat.getCurrencyInstance().format(c.saldo);
        this.infoConta.setText(context.getString(R.string.info_Conta, c.numero, string_saldo));
        ...
        this.btnEdit.setOnClickListener(
                v -> {
                    ...
                    i.putExtra(KEY_NUMERO_CONTA, c.numero);
