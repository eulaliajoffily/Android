...
public class CreditarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valorOperacao.setHint(valorOperacao.getHint() + " " +getString(R.string.creditado));
        tipoOperacao.setText(R.string.transacao_creditar);
                                    ...
                                    if (!valorOperacao.getText().toString().isEmpty()) {
                                        if (isNumber(valorOperacao.getText().toString())) {
                                            ...
                                            if (valor > 0) {
                                                ...
                                                runOnUiThread(() -> Toast.makeText(this, R.string.credito_sucesso, LENGTH_SHORT).show());
                                                ...
                                                Transacao t = new Transacao(0, 'C', numOrigem, valor, dataTransacao);
